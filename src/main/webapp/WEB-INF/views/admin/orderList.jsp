			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.LeiHou.model.Order o=(com.LeiHou.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.LeiHou.dao.UserDao userDao=new com.LeiHou.dao.UserDao();
						...
						<%
							...
							String paymentType=com.LeiHou.model.Payment.findByPaymentId(con,n);
							 %>
